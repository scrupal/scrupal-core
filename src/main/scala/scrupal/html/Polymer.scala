...
trait GenericPolymerIronTags[Builder, Output <: FragT, FragT] extends Util[Builder, Output, FragT] {
  ...
  val `a11y-announcer` : TypedTag[Builder, Output, FragT]
  val `a11y-keys` : TypedTag[Builder, Output, FragT]
  val `a11y-keys-behavior` : TypedTag[Builder, Output, FragT]
  val `ajax` : TypedTag[Builder, Output, FragT]
  val `autogrow-textarea` : TypedTag[Builder, Output, FragT]
  val `behaviors` : TypedTag[Builder, Output, FragT]
  val `checked-element-behavior` : TypedTag[Builder, Output, FragT]
  val `collapse` : TypedTag[Builder, Output, FragT]
  val `component-page` : TypedTag[Builder, Output, FragT]
  val `demo-helpers` : TypedTag[Builder, Output, FragT]
  val `doc-viewer` : TypedTag[Builder, Output, FragT]
  val `dropdown` : TypedTag[Builder, Output, FragT]
  val `fit-behavior` : TypedTag[Builder, Output, FragT]
  val `flex-layout` : TypedTag[Builder, Output, FragT]
  val `form` : TypedTag[Builder, Output, FragT]
  val `form-element-behavior` : TypedTag[Builder, Output, FragT]
  val `icon` : TypedTag[Builder, Output, FragT]
  val `icons` : TypedTag[Builder, Output, FragT]
  val `iconset` : TypedTag[Builder, Output, FragT]
  val `iconset-svg` : TypedTag[Builder, Output, FragT]
  val `image` : TypedTag[Builder, Output, FragT]
  val `input` : TypedTag[Builder, Output, FragT]
  val `jsonp-library` : TypedTag[Builder, Output, FragT]
  val `label` : TypedTag[Builder, Output, FragT]
  val `list` : TypedTag[Builder, Output, FragT]
  val `localstorage` : TypedTag[Builder, Output, FragT]
  val `media-query` : TypedTag[Builder, Output, FragT]
  val `menu-behavior` : TypedTag[Builder, Output, FragT]
  val `meta` : TypedTag[Builder, Output, FragT]
  val `overlay-behavior` : TypedTag[Builder, Output, FragT]
  val `page-url` : TypedTag[Builder, Output, FragT]
  val `pages` : TypedTag[Builder, Output, FragT]
  val `range-behavior` : TypedTag[Builder, Output, FragT]
  val `resizable-behavior` : TypedTag[Builder, Output, FragT]
  val `selector` : TypedTag[Builder, Output, FragT]
  val `signals` : TypedTag[Builder, Output, FragT]
  val `swipeable-container` : TypedTag[Builder, Output, FragT]
  val `test-helpers` : TypedTag[Builder, Output, FragT]
  val `validatable-behavior` : TypedTag[Builder, Output, FragT]
  val `validator-behavior` : TypedTag[Builder, Output, FragT]
}
...
trait GenericPolymerPaperTags[Builder, Output <: FragT, FragT] extends Util[Builder, Output, FragT] {
  import scalatags.generic.TypedTag
  val `badge` : TypedTag[Builder, Output, FragT]
  val `behaviors` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `button` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `card` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `checkbox` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `dialog` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `dialog-behavior` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `dialog-scrollable` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `drawer-panel` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `dropdown-menu` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `fab` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `header-panel` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `icon-button` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `input` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `item` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `listbox` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `material` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `menu` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `menu-button` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `progress` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `radio-button` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `radio-group` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `ripple` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `scroll-header-panel` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `slider` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `spinner` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `styles` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `tabs` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `toast` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `toggle-button` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `toolbar` : scalatags.generic.TypedTag[Builder, Output, FragT]
  val `tooltip` : scalatags.generic.TypedTag[Builder, Output, FragT]
}
